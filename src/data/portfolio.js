...
export const SKILL_GROUPS = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Scalability", pct: 68 },
      { name: "DSA", pct: 75 },
      { name: "Code Review", pct: 80 },
    ],
  },
];
...
export const PROJECTS = [
  {
    ...
    icon: "\u26A1",
    liveUrl: "http://3.26.203.59/",
    githubUrl: "https://github.com/ojaswi-bhar45/Sync-Board",
    stack: [
      "React.js",
      "Node.js",
      "Socket.io",
  ...
  },
  {
    ...
    icon: "\uD83D\uDCCA",
    liveUrl: "",
    githubUrl: "https://github.com/ojaswi-bhar45/DevPulse",
    stack: [
      "React.js",
      "JavaScript",
      "Tailwind CSS",
  ...
  },
  {
    ...
    icon: "\uD83C\uDFD8\uFE0F",
    liveUrl: "",
    githubUrl: "https://github.com/ojaswi-bhar45/WanderLust",
    stack: [
      "Node.js",
      "Express.js",
      "MongoDB",
  ...
  {
    name: "URL-Shorten",
    subtitle: "Backend URL Shortening Service",
    icon: "\uD83D\uDD17",
    liveUrl: "",
    githubUrl: "https://github.com/ojaswi-bhar45/URL-Shorten",
...
export const ACHIEVEMENTS = [
  {
    icon: "\uD83C\uDFC6",
    text: "<strong>Academic Excellence Award (Third year)</strong> \u2014 Top-performing student in MCA (Integrated)",
  },
  {
    icon: "\uD83D\uDCDC",
    text: "<strong>Full Stack Web Development (MERN) \u2014 Apna College, 2024</strong>",
  },
  {
    icon: "\uD83D\uDE80",
    text: "<strong>TechSymposium Hackathon</strong> \u2014 Built FitnessFreaker app in 24 hours",
  },
  {
    icon: "\u26A1",
...
export const BLOG = [
  {
    ...
    excerpt:
      "A deep dive into the architecture behind Sync-Board — handling concurrent edits, conflict resolution, and maintaining sub-50ms latency for 50+ simultaneous users.",
    date: "May 2026",
  ...
  },
  {
    ...
    excerpt:
      "A step-by-step guide to multi-stage Docker builds for React applications, covering Nginx configuration, environment variables, and CI/CD integration.",
    date: "Apr 2026",
  ...
  },
  {
    ...
    excerpt:
      "Lessons learned from building a 3-tier RBAC system — middleware architecture, route protection patterns, and balancing security with developer experience.",
    date: "Mar 2026",
  ...
  },
  {
    ...
    excerpt:
      "Practical strategies for indexing, aggregation pipeline optimization, and query profiling that reduced API response times by 35% in production.",
    date: "Feb 2026",
